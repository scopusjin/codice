...
EXPECTED_RANGES = {
    PARAM_ELECTRICAL_SUPRACILIARY: {
        ...
        SUPRA_PHASE_I: (5, 22),
        SUPRA_PHASE_II: (3.5, 16),
        SUPRA_PHASE_III: (3, 13),
        SUPRA_PHASE_IV: (2, 8),
        SUPRA_PHASE_V: (1, 7),
        SUPRA_PHASE_VI: (0, 6),
    ...
    PARAM_MECHANICAL_MUSCLE: {
        ...
        MECH_SMALL_PERSISTENT_SWELLING: (0, 13),
        OPTION_NO_REACTION: (1.5, INF_HOURS),
        OPTION_UNRELIABLE: None,
    },
    PARAM_CHEMICAL_PUPILLARY: {
        OPTION_NOT_ASSESSED: None,
        PUPILLARY_ATROPINE_DILATION: (0, 10),
        PUPILLARY_ATROPINE_NO_CHANGE: (3, INF_HOURS),
        PUPILLARY_TROPICAMIDE_DILATION: (0, 30),
        PUPILLARY_TROPICAMIDE_NO_CHANGE: (5, INF_HOURS),
        PUPILLARY_ACETYLCHOLINE_REDUCTION: (0, 46),
        PUPILLARY_ACETYLCHOLINE_NO_CHANGE: (14, INF_HOURS),
        OPTION_UNRELIABLE: None,
    },
}
