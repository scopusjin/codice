# -*- coding: utf-8 -*-
"""Historical FC engine, retained only for compatibility.

The active panel uses app/fc_panel_frontend/index.html. Do not import this
module from application pages or output code: its calculation rules are obsolete.
"""
...
from app.fc_description import build_cf_description  # compatibility export
